...
if __name__ == '__main__':
    ...
    # create_global(cwd)
    # print(iterate_mapping(regions_data, "scalars[? parameter_name=='installed capacity' && region == 'BY' && technology=='storage' && technology_type=='pumped'].{y: year, v: value}"))
    # print(min(iterate_mapping(regions_data, "unique(scalars[? parameter_name=='lifetime'].value)")))