...
def select_expansion_procedure(expansion_limit):
    ...
    if is_list_elem_same(expansion_value):
        ...
        return {2016: expansion_limit[0]['value']/4, 2019: expansion_limit[0]['value']/4, 2020: max((expansion_limit[1]['value']-expansion_limit[0]['value'])/10, 0),
            2029: max((expansion_limit[1]['value']-expansion_limit[0]['value'])/10, 0), 2030: max((expansion_limit[2]['value']-expansion_limit[1]['value'])/10, 0),
            2039: max((expansion_limit[2]['value']-expansion_limit[1]['value'])/10, 0), 2040: max((expansion_limit[3]['value']-expansion_limit[2]['value'])/10, 0),
            2050: max((expansion_limit[3]['value']-expansion_limit[2]['value'])/10, 0)}
